defmodule AdminsetupWeb.ClientControllerTest do
  use AdminsetupWeb.ConnCase

  alias Adminsetup.Customers

  @create_attrs %{gender: "some gender", location: "some location", name: "some name"}
  ...
  def fixture(:client) do
    {:ok, client} = Customers.create_client(@create_attrs)
    client
  end
